...
// Local logos (from /img/teams). Update paths if you rename files.
const TEAM_LOGOS = {
  "Real Madrid": "img/teams/rmcf.png",
  "Liverpool": "img/teams/lfc.png",
  "Brazil": "img/teams/brazil.png",
  "Germany": "img/teams/germany.png",
  "France": "img/teams/france.png",
  "Croatia": "img/teams/croatia.png",
  "Barcelona": "img/teams/fcb.png",
  "Bayern Munich": "img/teams/bayern.png",
  "Paris Saint-Germain": "img/teams/psg.png",
  "Borussia Dortmund": "img/teams/bvb.png",
  "Juventus": "img/teams/juve.png",
  "Manchester United": "img/teams/manu.png",
  "Atlético Madrid": "img/teams/atletico.png",
  "Chelsea": "img/teams/cfc.png",
  "Manchester City": "img/teams/mancity.png",
  "Spain": "img/teams/spain.png",
  "Italy": "img/teams/italy.png",
  "Portugal": "img/teams/portugal.png",
  "Netherlands": "img/teams/netherlands.png",
  "Queens Park Rangers": "img/teams/qpr.png",
  "Inter": "img/teams/inter.png",
  "Argentina": "img/teams/argentina.png",
  "Saudi Arabia": "img/teams/saudi.png",
  "Crystal Palace": "img/teams/crystalpalace.png", // will fallback if missing
  // Add new teams as needed, e.g.:
  "AC Milan": "img/teams/acmilan.png",
  "Ajax": "img/teams/ajax.png",
  "AS Roma": "img/teams/asroma.png",
  "Aston Villa": "img/teams/astonvilla.png",
  "Atalanta": "img/teams/atalanta.png",
  "Benfica": "img/teams/benfica.png",
  "Celtic": "img/teams/celtic.png",
  "Feyenoord": "img/teams/feyenoord.png",
  "Fiorentina": "img/teams/fiorentina.png",
  "Galatasaray": "img/teams/galatasaray.png",
  "Lazio": "img/teams/lazio.png",
  "Leverkusen": "img/teams/leverkusen.png",
  "Lille": "img/teams/lille.png",
  "Monaco": "img/teams/monaco.png",
  "Napoli": "img/teams/napoli.png",
  "Nice": "img/teams/nice.png",
  "Porto": "img/teams/porto.png",
  "Sevilla": "img/teams/sevilla.png",
  "Sporting": "img/teams/sporting.png",
  "Spurs": "img/teams/spurs.png",
  "West Ham": "img/teams/whu.png",
};
// Use a tournament badge as placeholder
const DEFAULT_LOGO = "img/tournaments/ucl.png"; // use any local placeholder you like
